...
const Lists = ({ title, content, price, period, bgColor }) => {
  return (
    ...
    >
      {bgColor && (
        <div className="absolute price--line top-0 left-0 right-0 w-full h-[6px] md:rotate-90 md:w-[16.875rem] md:top-[8.25rem] md:-left-[8.25rem]" />
      )}
      <heading className="flex flex-col gap-y-[1.125rem] px-[1.375rem] md:px-3">
        <h3 className="text-[1.5rem] font-bold leading-[1.5625rem] text-center capitalize md:text-left">
          {title}
        </h3>
        <p className="text-center opacity-60 text-[0.9375rem] leading-[1.5625rem] md:text-left">
          {content}
        </p>
      </heading>
