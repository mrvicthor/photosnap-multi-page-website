...
import pinteresIcon from "../../assets/shared/desktop/pinterest.svg";
...
const Layout = ({ children }) => {
  return (
    <div className="grid layout">
      ...
      <footer className="footer bg-[#000000] text-[#ffffff] py-[3.5rem] pl-[2.0625rem] pr-8">
        <div className="grid justify-items-center">
          ...
          <div className="mt-8 footer--socials flex gap-x-4 ">
            ...
            <a href="" className="footer--socials-pinterest">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20">
                <defs>
          ...
          <div className="mt-[3.0625rem] flex flex-col items-center gap-y-[1.1875rem]">
            <Link className="block  font-bold text-[0.75rem] leading-[15.62px] tracking-[2px] uppercase cursor-pointer">
              home
            </Link>
            <Link className="block font-bold text-[0.75rem] leading-[15.62px] tracking-[2px] uppercase cursor-pointer">
              stories
          ...
          <LinkButton btnText="get an invite" style="mt-[7.4375rem]">
            <svg
          ...
          <p className="mt-[2.125rem] font-normal text-[0.9375rem] leading-[19.53px] opacity-50">
