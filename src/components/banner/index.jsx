...
const Banner = ({ bgImage, bgTablet, bgDesktop, title, content, notHome }) => {
  const { width } = useWindowSize();
  return (
    <section>
      <div className={`${notHome ? "shared-layout" : "banner"} grid`}>
        ...
        <div className="bg-[#000000] text-[#ffffff] pl-[2.0625rem] pb-[4.5rem] pr-6 md:relative md:px-[3.375rem] md:py-[10.8125rem] lg:px-[7rem]">
          <div
            className={`line h-[6px] w-[8rem] ${
              notHome
                ? "md:w-[9rem] md:top-[15.5rem] md:-left-[4.125rem]"
                : "md:w-[19rem] md:-left-[9.125rem] md:top-[20.5rem]"
